...
func TestTransferTx(t *testing.T) {
	...
	account2 := createRancomAccount(t)
	...
	require.Equal(t, account1.Balance-int32(n*int(amount)), updateAccount1.Balance)
	require.Equal(t, account2.Balance+int32(n*int(amount)), updateAccount2.Balance)
}
